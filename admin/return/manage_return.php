...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Detalhes do Empréstimo - ".$return_code : 'Criar novo registro' ?></h4>
    </div>
    <div class="card-body">
        <form action="" id="return-form">
            ...
            <div class="container-fluid">
                ...
                <label for="re_solicitante" class="control-label">Solicitante</label>
                <input type="text" name="re_solicitante" class="form-control form-control-sm rounded-0" value="<?php echo isset($re_solicitante) ? $re_solicitante : '' ?>" >
                </div>
                </div>
                </div>
                <div class="row">
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-primary" type="submit" form="return-form">Salvar</button>
    ...
    $(function(){
        ...
        $('#supplier_id').change(function(){
            ...
            if(!!items[supplier_id]){
                ...
                list_item.then(function(){
                    $('#item_id').select2({
                        placeholder:"Sem itens na lista",
                        width:'resolve',
                    })
                })
            }
        ...
        $('#add_to_list').click(function(){
            ...
            if($('table#list tbody').find('tr[data-id="'+item+'"]').length > 0){
                alert_toast('Item ja existe na lista','error');
                return false;
            }
