...
<br>
        ...
        <a class="toggle-vis btn btn-outline-primary btn-sm" data-column="6">Data</a>
          ...
          <div class="table-responsive">
                <table class="table table-striped table-bordered tabela-form-r" id="list_financeiro" style="width:100%;">
                        <thead>
    ...
    <?php } ?>
                    ...
                    <div class="form-group" style="display:none;">
                        ...
                        <select name="estado_requisicao" id="estado_requisicao" class="custom-select select2" required>
                            ...
                            <option value="6" selected <?php echo isset($estado_requisicao) && $estado_requisicao == 6 ? 'selected' : '' ?>>financeiro</option>
                        </select>
                    </div>
                    
                    <!-- ETAPA CONCLUÍDA -->
<div style="display:none;">
<select name="etapa_financeiro" id="etapa_financeiro" class="select2" style="width:100%">
                            <option selected value="1" <?php echo isset($etapa_financeiro) && $etapa_financeiro == 1 ? 'selected' : '' ?>>concluido</option>
                        </select>
                        </div>
...
<?php if(empty($servico_anexo1) && empty($servico_anexo2) && empty($servico_anexo3)){
 ?>
 <div class="card card-outline card-primary">
 <div class="card-header"das>
    <h4 class="card-title"><strong>SERVIÇOS</strong></h4>
    </div>
<div class="card-body">
<div class="text-center"><i><strong>sem anexos</strong></i></div>
</div>
 </div>
 <?php } 
else{ ?> 
...
<div class="p-2">
<!-- MOSTRAR servico_anexo1 -->
<?php if(empty($servico_anexo1)){
}
else{ ?>
<a class="btn btn-outline-primary btn-sm" data-toggle="collapse" href="#collapseServico1" role="button" aria-expanded="false" aria-controls="collapseServico1">
<i class="fa-solid fa-paperclip"></i> Exibir recibo</a>
<?php } ?>

<!-- MOSTRAR servico_anexo2 -->
<?php if(empty($servico_anexo2)){
}
else{ ?>
<a class="btn btn-outline-primary btn-sm" data-toggle="collapse" href="#collapseServico2" role="button" aria-expanded="false" aria-controls="collapseServico2">
<i class="fa-solid fa-paperclip"></i> Exibir nota fiscal</a>
<?php } ?>
<!-- MOSTRAR servico_anexo3 -->
<?php if(empty($servico_anexo3)){
}
else{ ?>
<a class="btn btn-outline-primary btn-sm" data-toggle="collapse" href="#collapseServico3" role="button" aria-expanded="false" aria-controls="collapseServico3">
<i class="fa-solid fa-paperclip"></i> Exibir contrato</a>
<?php } ?>
...
<!-------------------------------------------------- FILE 1 -------------------------------------------->
 ...
 <!-- div collapse -->
<div class="collapse multi-collapse text-center" id ="collapseServico1">
 <!-- download servico_anexo1 -->
...
<!-------------------------------------------------- FILE 2 -------------------------------------------->
 ...
 <!-- div collapse -->
<div class="collapse multi-collapse text-center" id ="collapseServico2">
 <!-- download servico_anexo2 -->
...
<!-------------------------------------------------- FILE 3 -------------------------------------------->
 ...
 <!-- div collapse -->
<div class="collapse multi-collapse text-center" id ="collapseServico3">
 <!-- download servico_anexo3 -->
...
<div class="card card-outline card-primary">
<div class="card-header">
    <h4 class="card-title"><strong>FINANCEIRO</strong></h4>
    </div>
<div class="card-body">
<div class="text-center">
<h6>O pagamento será realizado ? *</h6>
<div class="btn-group btn-group-toggle" data-toggle="buttons">
  <label class="btn btn-rounded bt-active0" style="width: 150px;">
  <input type="radio" id="req_aprov3" name="req_aprov3" value="0" <?php echo isset($req_aprov3) && $req_aprov3 == 0 ? 'selected' : '' ?>required> Não
    
  </label>
  <label class="btn btn-rounded bt-active1" style="width: 150px;">
    <input type="radio" id="req_aprov3" name="req_aprov3" value="1" <?php echo isset($req_aprov3) && $req_aprov3 == 1 ? 'selected' : '' ?>required> Sim
  </label>
</div>
</div>
...
<br><br>
    ...
    <a class="col-2 col-sm-2 col-md-2 btn btn-outline-dark" href="<?php echo base_url.'/admin?page=financeiro' ?>"><strong>Voltar</strong></a>
...
var table = $('#list_financeiro').DataTable({
    paging:false,
    "lengthChange": false,
    "searching": false,
    "bInfo" : false,
			...
			$.ajax({
				...
				success:function(resp){
					if(resp.status == 'success'){
                        location.replace(_base_url_+"admin/?page=financeiro");
