...
<div class="card-body">
        <div class="row d-flex align-items-center">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 text-center">
                            ...
                            <textarea name="obs_autorizacao" tabindex="-1" id="obs_autorizacao" style="width:100%;" rows="3" class="text-center"><?php echo isset($obs_autorizacao) ? $obs_autorizacao : '' ?></textarea>
                    </div>
