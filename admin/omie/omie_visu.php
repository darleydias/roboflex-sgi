...
<strong><?php echo 'REQUISICAO ' .$po_code ?></strong>
                    ...
                    <tbody>
                        ...
                        <tr>
                           <!--  <td class="py-1 px-2 text-center">
                            ...
                            <td class="py-1 px-2 cat_compra" style="min-width:150px;">
                            ...
                            <td class="py-1 px-2 obs_item" style="min-width: 250px;">
                            <?php echo $row['obs_item']; ?>
                            </td>

                           <td class="py-1 px-2 obs_item" style="min-width: 150px;">
                            <?php echo $row['fornecedor_item']; ?>
                            </td>

                            <td class="py-1 px-2 prev_data text-center" style="min-width: 100px;">
...
<div class="footer fixed-bottom card-footer">
        ...
        <a class="col-2 col-sm-2 col-md-2 btn btn-outline-primary" style="width:100%;" href="<?php echo base_url.'/admin?page=omie' ?>"><strong>VOLTAR</strong></a>
</div>
