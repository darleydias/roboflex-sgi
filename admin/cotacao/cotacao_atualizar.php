...
<?php } ?>
    ...
    <div>
        ...
        <td><a class="toggle-vis btn btn-outline-primary btn-sm bt-disabled" data-column="1">Nome</a></td>
...
<div class="table-responsive">
                ...
                <table class="table table-striped table-bordered tabela-form-r" id="tb_cotacao_atualizar" style="width:100%">
               <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-1 px-2 text-center qty">
                                ...
                                <input type="number" name="qty[]" class="select2 text-center" style="width:70px !important" tabindex="-1" value="<?php echo $row['qty']; ?>" max = "" min="0">
                                </div>
                            ...
                            <td class="d-flex justify-content-center" style="<?php echo $etapa_mat_ou_ser == 1 ? "" : "display:none;" ?>">
                            ...
                            <td align="center" class="cotacao_1">
         
                            <div class="d-flex align-items-center" style="width:400px;">

                            <div>
                            <label for="cotacao_1_0" class="control-label">Fornecedor</label><br>
                            <input type="text" class="form-control input-cotacao" name="cot1[]" value="<?php echo $row['cot1'];?>" style="width:150px;" required>
                            </div>
                            ...
                            <input type="text" class="form-control input-cotacao MoneyFormat" name="cot2[]" value="<?php echo $row['cot2'];?>" required>
                            </div>
                            </div>
                            ...
                            <div class="inner-addon left-addon">
                            <i class=" fa-solid fa-brazilian-real-sign"></i>
                            <input type="text" class="form-control input-cotacao MoneyFormat" name="cot3[]" value="<?php echo $row['cot3'];?>">
                            </div>
                            ...
                            <td align="center" class="cotacao_2">
                            <div class="d-flex align-items-center" style="width:400px;">

                            <div>
                            <label for="cotacao_2_0" class="control-label">Fornecedor</label><br>
                            <input type="text" class="form-control input-cotacao" name="cot4[]" value="<?php echo $row['cot4'];?>" style="width:150px;">
                            </div>
                            ...
                            <div class="inner-addon left-addon">
                            <i class=" fa-solid fa-brazilian-real-sign"></i>
                            <input type="text" class="form-control input-cotacao MoneyFormat" name="cot5[]" value="<?php echo $row['cot5'];?>">
                            </div>
                            </div>
                            ...
                            <div class="inner-addon left-addon">
                            <i class=" fa-solid fa-brazilian-real-sign"></i>
                            <input type="text" class="form-control input-cotacao MoneyFormat" name="cot6[]" value="<?php echo $row['cot6'];?>">
                            </div>
                            </div>
                            ...
                            <td align="center" class="cotacao_3">
                            <div class="d-flex align-items-center" style="width:400px;">

                            <div>
                            <label for="cotacao_3_0" class="control-label">Fornecedor</label><br>
                            <input type="text" class="form-control input-cotacao" name="cot7[]" value="<?php echo $row['cot7'];?>" style="width:150px;">
                            </div>
                            ...
                            <div class="inner-addon left-addon">
                            <i class=" fa-solid fa-brazilian-real-sign"></i>
                            <input type="text" class="form-control input-cotacao MoneyFormat" name="cot8[]" value="<?php echo $row['cot8'];?>">
                            </div>
                            </div>
                            ...
                            <div class="inner-addon left-addon">
                            <i class=" fa-solid fa-brazilian-real-sign"></i>
                            <input type="text" class="form-control input-cotacao MoneyFormat" name="cot9[]" value="<?php echo $row['cot9'];?>">
                            </div>
                            </div>
...
<br>
        ...
        <div class="col-12 col-sm-6 col-md-3 text-center">
                    ...
                    <?php } ?>
                        ...
                        <div class="col-12 col-sm-6 col-md-3 text-center">
                                ...
                                <input type="date" name="data_autorizacao" tabindex="-1" id="data_autorizacao" class="select2 text-center" style="width:100%;" value="<?php echo isset($data_autorizacao) ? $data_autorizacao : ''; ?>">
                        </div>  
                    </div>
              <br>
        </div> <!-- card -->
    ...
    <button type="submit" disabled style="display: none" aria-hidden="true" form="receive-form"> </button>
 
    <a class="col-2 col-sm-2 col-md-2 btn btn-outline-dark" href="<?php echo base_url.'/admin?page=cotacao' ?>"><strong>Voltar</strong></a>
    <button class="col-2 col-sm-2 col-md-2 btn btn-outline-success" type="submit" form="receive-form"><strong>Atualizar</strong></button>
...
var table = $('#tb_cotacao_atualizar').DataTable({
    "autoWidth": false,
        "lengthChange": false,
        "searching": false,
        "bInfo" : false,
			...
			$.ajax({
				...
				success:function(resp){
					if(resp.status == 'success'){
                        ...
                        location.replace(_base_url_+"admin/?page=cotacao/cotacao_aprov");
