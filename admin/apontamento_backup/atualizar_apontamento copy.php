...
<button type="button" class="btn btn-success botao-horas-col4" value="" <?php echo $disabled4 ?>><span class="fa-solid fa-clock"></span></button> 
...
<button type="button" class="btn btn-success botao-horas-col5" value="" <?php echo $disabled5 ?>><span class="fa-solid fa-clock"></span></button> 
</td>
...
$(".botao-horas-col2").click(function() {
    var tableRow = $(this).closest("tr"); 
    var dataAtual = moment().format('YYYY-MM-DDTHH:mm:ss');
    var dataFinal = Number(tableRow1.find(".final-total-col2").val(dataAtual));
