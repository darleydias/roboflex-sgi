            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center align-items-end">
                    ...
                    <div class="col-sm-6 col-md-2 text-center">
                            ...
                            <select name="supplier_id" id="supplier_id" style="width:100%;" class="select2 text-center" style="width:100%">
...
<!-- style="width:200px; min-width:70%; max-width:90%;" -->
                        ...
                        <label for="unit" class="control-label">Solicitante</label>
                        ...
                        <?php elseif($_settings->userdata('type') == '26'): ?>
                            <select name="unit" id="unit" class="text-center" style="width:100%" multiple="multiple">
                            <?php
...
<?php endif; ?>
                        ...
                        <div class="row justify-content-center align-items-end">
                        <div class="text-center">
                        <button type="button" style="width:100%; height:50px;" class="btn bg-red" id="add_to_list"><span class="fas fa-plus"></span> Adicionar Apontamento</button>
                        </div>
...
elseif ($row['cot2'] == '0000-00-00 00:00:00') {
$disabled1 = "disabled";
$disabled2 = "";
$disabled3 = "disabled";
}
elseif ($row['cot3'] == '0000-00-00 00:00:00') {
$disabled1 = "disabled";
$disabled2 = "disabled";
$disabled3 = "";
}
...
elseif ($row['cot5'] != '0000-00-00 00:00:00'){
$disabled4 = "disabled";
$disabled5 = "disabled";
}
...
<td>
<input type="number" step="any" style="width:60px" class="form-control input-cotacao text-center" name="cot14[]" value="<?php echo $row['cot14']?>">
</td>

<td>
<input type="text" autocomplete="off" style="width:150px" class="form-control input-cotacao" name="cot15[]" value="<?php echo $row['cot15']?>">
</td>
