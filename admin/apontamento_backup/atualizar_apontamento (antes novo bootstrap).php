        ...
        <form action="" id="apontamento-form" enctype="multipart/form-data">
                    ...
                    <div class="col-12 col-sm-6 col-md-3 offset-md-1 text-center">
                       <!--  <label for="req_date" class="control-label">Data</label>
                        ...
                        <.?php echo date('d-m-Y H:i:s', strtotime($req_date)) ?> readonly> -->
                         ...
                         <label for="req_date" class="control-label">Data</label>
                        <input type="datetime" name="req_date" id="req_date" class="form-control rounded-0 text-center" tabindex="-1" value="<?php echo date("d-m-Y H:i:s", strtotime($req_date)) ?>" readonly>
           ...
           <br>
                        ...
                        <select id="unit" class="select2" style="width:100%" multiple>
                            <option value="Colaborador1" <?php echo $unit == 0 ?>>Colaborador11</option>
                            <option value="Colaborador2" <?php echo $unit == 1 ?>>Colaborador2</option>
                            <option value="Colaborador3" <?php echo $unit == 2 ?>>Colaborador3</option>
                            <option value="Colaborador4" <?php echo $unit == 3 ?>>Colaborador4</option>
                            <option value="Colaborador5" <?php echo $unit == 4 ?>>Colaborador5</option>
                            <option value="Colaborador6" <?php echo $unit == 5 ?>>Colaborador6</option>
                        </select>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 text-center">
                                <label for="prev_data" class="control-label">Início do Serviço</label>
                                <input type="datetime-local" step="any" class="form-control rounded-0 text-center" id="prev_data" value="">
                            </div>
                            <div class="">
                                <br>
...
<div class="table-responsive">
            ...
            <colgroup>
                        ...
                        <col width="10%"> <!-- colab -->
                       <!--  <col width="10%"> -->
                        <col width="15%"> <!-- data inicio -->
                        <col width="10%"> <!-- data parcial -->
                        <col width="10%"> <!-- data final -->
                    </colgroup>
                <thead>
                    <tr class="bg-primary table-active text-light">
                       ...
                       <!--  <th class="text-center py-1 px-2 align-middle">Observação</th> -->
                        <th class="text-center py-1 px-2 align-middle">Data Início</th>
                        <th class="text-center py-1 px-2 align-middle">Final Parcial</th>
                        <th class="text-center py-1 px-2 align-middle">Final Total</th>
                    ...
                    ?>
                            <tr>
                               ...
                               <!--  <td class="py-1 px-2 obs_item">
                                ...
                                <!-- <td>
                                <input type="text" <?php echo empty($row['cot1']) ? '' : 'readonly' ?> class="form-control input-cotacao" name="cot1[]" value="<?php echo $row['cot1']; ?>" required>
                                </td> -->


                                <td>
                                <input type="datetime-local" step="any" name="cot1[]" value="<?php echo $row['cot1']; ?>">
                                </td>

                                <td>
                                <input type="datetime-local" step="any" name="cot2[]" value="<?php echo $row['cot2']; ?>">   
                                </td>
                                
                                <!-- <?php echo empty($row['cot2']) ? '' : 'readonly' ?> -->
    ...
    $(function() {
        ...
        $('#add_to_list').click(function() {
           ...
           /*  var obs_item = $('#obs_item').val().replace(/'/g, '"'); */
            ...
            var prev_data = $('#prev_data').val().replace("T"," ");
