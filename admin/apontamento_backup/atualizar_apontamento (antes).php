                    ...
                    <div class="col-12 col-sm-6 col-md-3 offset-md-1 text-center">
                       <!--  <label for="req_date" class="control-label">Data</label>
                        ...
                        <.?php echo date('d-m-Y H:i:s', strtotime($req_date)) ?> readonly> -->
                         ...
                         <label for="req_date" class="control-label">Data</label>
                        <input type="datetime" name="req_date" id="req_date" class="form-control rounded-0 text-center" tabindex="-1" value="<?php echo $req_date ?>" readonly>
                    ...
                    ?>
                            <tr>
                               ...
                               <td class="py-1 px-2 text-center unit">
                                ...
                                <td>
                                <input type="text" class="form-control input-cotacao" name="cot1[]" value="<?php echo $row['cot1']; ?>" required>
                                </td>

                                <td>
                                <input type="text" step="any" class="form-control input-cotacao MoneyFormat" data-thousands="" data-decimal="," name="cot2[]" value="<?php echo $row['cot2']; ?>">   
                                </td>
