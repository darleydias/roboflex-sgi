...
<div class="card-header">
    <strong><?php echo 'REQUISIÇÃO ' .$po_code ?></strong>
    </div>
<div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td class="py-1 px-2 obs_item">
                            ...
                            <td class="py-1 px-2 cotacao_1" style="min-width: 400px;">
...
<div class="footer fixed-bottom card-footer">
        ...
        <a class="col-2 col-sm-2 col-md-2 btn btn-outline-primary" style="width:100%;" href="<?php echo base_url.'/admin?page=requisicoes' ?>
             ">VOLTAR</a>
