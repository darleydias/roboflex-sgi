...
<div class="card card-outline card-warning">
    <div class="card-header">
        <h4 class=" padding center text-dark"><?php echo isset($id) ? "Detalhes Requisição de Entrada - " . $po_code : ' Requisição de Material' ?></h4>
    </div>
    <div class="card-body">
    ...
    <select name="req_projeto" id="req_projeto" class="select2" style="width:100%" onclick="toggleInput();" required>
        <!-- <.?php if($_settings->userdata('type') == '14') : ?>
