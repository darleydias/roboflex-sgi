...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h4 class="text-center padding">Lista de Serviços</h4>
			...
			<div class="container-fluid">
				...
				<colgroup>
					...
					<tbody>
						...
						on i.supplier_id = s.id where i.mat_ou_ser = 0
...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("Tem certeza que deseja deletar este serviço permanentemente?", "delete_category", [$(this).attr('data-id')])
		})
		$('#create_new').click(function() {
			uni_modal("<i class='fa fa-plus'></i> Adicionar novo serviço", "maintenance/manage_servico.php", "mid-large")
		})
		$('.edit_data').click(function() {
			uni_modal("<i class='fa fa-edit'></i> Editar Serviço", "maintenance/manage_servico.php?id=" + $(this).attr('data-id'), "mid-large")
		})
		$('.view_data').click(function() {
			uni_modal("<i class='fa fa-box'></i> Detalhes do Serviço", "maintenance/view_servico.php?id=" + $(this).attr('data-id'), "")
		})
	...
	function delete_category($id) {
		start_loader();
		$.ajax({
			url: _base_url_ + "classes/Master.php?f=delete_servico",
			method: "POST",
			data: {
				id: $id
			},
