...
<div class="card card-outline card-success">
	<div class="card-header">
		<h4 class="text-center padding">Categoria de materiais e serviços</h4>
...
<script>
	$(document).ready(function() {
		...
		$('.edit_data').click(function() {
			uni_modal("<i class='fa fa-edit'></i> Editar", "maintenance/manage_supplier.php?id=" + $(this).attr('data-id'), "mid-large")
		})
