...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h4 class="text-center padding">Setores</h4>
	...
	<div class="card-body">
		<div class="container-fluid">
			<div class="container-fluid">
				<table class="table table-bordered table-striped" id="tb_tipo">
					<colgroup>
						<col width="5%">
						<col width="20%">
						<col width="25%">
					...
					<tbody>
						<?php
						$i = 1;
						$qry = $conn->query("SELECT * from `setor_list`  order by `name` asc ");
...
<script>
	$(document).ready(function() {
		...
		$('.edit_data').click(function() {
			uni_modal("<i class='fa fa-edit'></i> Editar setor", "maintenance/manage_setor.php?id=" + $(this).attr('data-id'), "mid-large")
		})
	...
	function delete_category($id) {
		start_loader();
		$.ajax({
			url: _base_url_ + "classes/Master.php?f=delete_setor",
			method: "POST",
			data: {
				id: $id
			},
