...
<div class="card card-outline card-success">
    ...
    <div class="card-body">
        ...
        <a class="toggle-vis btn btn-outline-primary btn-sm bt-disabled" data-column="0">Requisição</a>
...
<?php if($_settings->userdata('user_adm') == 'ADM') : ?>
    ...
    <?php
                        ...
                        WHERE r.req_aprov = 1 and etapa_autorizacao = 1
                        group by p.id");
...
<?php
                        ...
                        inner join receiving_list r on r.form_id = p.id
                        inner join po_items i on i.po_id = p.id
                        WHERE r.req_aprov = 1 and p.req_grupo = '$usuario_setor' and etapa_autorizacao = 1
                        group by p.id");
                        while ($row = $qry->fetch_assoc()) : ?>
