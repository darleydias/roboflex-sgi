...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Entrega Pendente - <?php echo $bo_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label">Recebido da Requisição de Entrada: </label>
                ...
                <div class="col-md-6">
                    <label class="control-label">Código Entrada Pendente</label>
                    <div><?php echo isset($bo_code) ? $bo_code : '' ?></div>
                </div>
            </div>
</br>
            <h4 class="text-info">Requisição</h4>
            <table class="table table-striped table-bordered" id="list">
                ...
                <tfoot>
                    ...
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">Desconto <?php echo isset($discount_perc) ? $discount_perc : 0 ?>%</th>
                        <th class="text-right py-1 px-2 discount"><?php echo isset($discount) ? number_format($discount,2) : 0 ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">Taxas <?php echo isset($tax_perc) ? $tax_perc : 0 ?>%</th>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=back_order' ?>">Voltar à lista</a>
    </div>
</div>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Requisição de Entrada - Print View")
