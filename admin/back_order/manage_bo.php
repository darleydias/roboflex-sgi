...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <form action="" id="po-form">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label">Código ordem de entrada</label>
                ...
                <hr>
                <fieldset>
                    <legend class="text-info">Lista de Itens</legend>
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="qty" class="control-label">Qnt</label>
                                <input type="number" step="any" class="form-control rounded-0" id="qty">
                            </div>
                        </div>
                        <div class="col-md-2 text-center">
                            <div class="form-group">
                                <button type="button" class="btn btn-flat btn-sm btn-primary" id="add_to_list">Adicionar à lista</button>
                            </div>
                        </div>
                </fieldset>
                <hr>
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <thead>
                        <tr class="text-light bg-navy">
                            ...
                            <th class="text-center py-1 px-2">Qnt</th>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">Desconto <input style="width:40px !important" name="discount_perc" class='' type="number" min="0" max="100" value="<?php echo isset($discount_perc) ? $discount_perc : 0 ?>">%
                        ...
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">Taxas <input style="width:40px !important" name="tax_perc" class='' type="number" min="0" max="100" value="<?php echo isset($tax_perc) ? $tax_perc : 0 ?>">%
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=requisicoes' ?>">Cancelar</a>
    </div>
</div>
...
<script>
    ...
    $(function(){
        ...
        $('#supplier_id').change(function(){
            ...
            if(!!items[supplier_id]){
                ...
                list_item.then(function(){
                    $('#item_id').select2({
                        placeholder:"Escolha o item primeiro",
                        width:'resolve',
                    })
                })
            }else{
        ...
        $('#add_to_list').click(function(){
            ...
            if(item == '' || qty == '' || unit == '' ){
                alert_toast('Necessário preencher Unidade e Quantidade.','warning');
                return false;
            }
