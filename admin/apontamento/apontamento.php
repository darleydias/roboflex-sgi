...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        ...
        <input type="text" name="setor_apontamento" tabindex="-1" id="usuario_apontamento" class="text-center" style="width:100%;" value="<?php echo ($_settings->userdata('usuario_setor')) ?>">
        <input type="text" name="abr_setor_apontamento" tabindex="-1" id="abr_usuario_apontamento" class="text-center" style="width:100%;" value="<?php echo ($_settings->userdata('abr_usuario_setor')) ?>">    
    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-around">
                    ...
                    <input type="number" min="1000" max="9999" autocomplete="off" name="apontamento_op" id="apontamento_op" class="form-control rounded-0 text-center" value="<?php echo isset($apontamento_op) ? $apontamento_op : ''; ?>" required>
                    </div>
...
<div class="card-footer py-1 text-center">
    ...
    <!-- FIM -->
    <div class="row">
    <a style="width:50%;" class="btn btn-outline-secondary" href="<?php echo base_url . '/admin?page=apontamento' ?>"><strong>Voltar</strong></a>
    <button style="width:50%;" class="btn btn-outline-success" type="submit" form="apontamento-form"><strong>Salvar</strong></button>
    </div>
    <br>
</div>
