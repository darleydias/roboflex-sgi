...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<!-- ATALHO PARA CRIAÇÃO DE ITENS PARA ESTOQUE--> 
        <!-- <div class="card-tools">
			<a href="<?php echo base_url ?>admin/?page=requisicoes/solicitacao_material" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Criar novo</a>
		</div> -->
	</div>
	<div class="card-body">
		<div class="container-fluid">
        <div class="container-fluid">
			<table class="table table-bordered table-stripped" id="tb_estoque">
                    <colgroup>
                        <col width="5%">
                        <col width="20%">
                        <col width="20%">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Você tem certeza que deseja deletar essa ordem permanentemente?","delete_receiving",[$(this).attr('data-id')])
		})
