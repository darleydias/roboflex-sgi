...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Registro de Saída - ".$sales_code : 'Criar novo registro' ?></h4>
    </div>
    <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="client" class="control-label">Solicitante</label>
                ...
                <fieldset>
                    ...
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-2 text-center">
                            <div class="form-group">
                                <button type="button" class="btn btn-flat btn-sm btn-primary" id="add_to_list">Adicionar a lista</button>
                            </div>
                        </div>
                </fieldset>
                <hr>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=sales' ?>">Cancelar</a>
    </div>                                      
</div>
    ...
    $(function(){
        ...
        $('#add_to_list').click(function(){
            ...
            if($('table#list tbody').find('tr[data-id="'+item+'"]').length > 0){
                alert_toast('Item já está na lista.','error');
                return false;
            }
