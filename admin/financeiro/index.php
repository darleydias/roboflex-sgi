...
<div class="card card-outline card-gray">
	<div class="card-header">
		<h4 class="text-center padding">Financeiro</h4>
...
<div>
<a id="btnTabela2" class="btn btn-success" onclick="exibirTabela(2)">Aprovados</a>
</div>
<div>
<a id="btnTabela3" class="btn btn-danger" onclick="exibirTabela(3)">Recusados</a>
</div>
</div>
<br>
...
<br>
        ...
        <table class="table nowrap" id="tb_completa" style="width:100%;">
                    ...
                    <tbody>
                        ...
                        OR (r.estado_requisicao = 7 and req_aprov2 = 1 and not nome_aprovacao2 = '' and not nome_aprovacao3 = '' and total_aprov >= 9000000.01)");
                        ...
                        ?>
                            <tr>
                                ...
                                <?php if ($row['estado_requisicao'] == 7) : ?>
                                <span class="badge badge-warning rounded-pill">Aguardando pagamento</span>
                                <?php endif; ?>
                                </td>
                                ...
                                <td align="center">
                                <a class="dropdown-item bg-warning" href="<?php echo base_url.'admin?page=receiving/manage_financeiro&id='.$row['id'] ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-edit text-black"></span></a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                <?php if ($row['req_aprov3'] == 1) : ?>
                                <span class="badge badge-success rounded-pill">Pagamento realizado</span>
                                <?php endif; ?>
                                </td>
                                ...
                                <td align="center">
                                <a class="dropdown-item" href="<?php echo base_url.'admin?page=financeiro/financeiro_visu&id='.$row['id'] ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-black"></span></a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                <?php if ($row['req_aprov3'] == 0) : ?>
                                <span class="badge badge-danger rounded-pill">Pagamento recusado</span>
                                <?php endif; ?>
                                </td>
